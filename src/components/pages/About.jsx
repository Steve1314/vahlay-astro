...
const services = [
  {
    title: "Courses",
    description:
      "Master the Art of Astrology – Learn, Grow, and Align with the Cosmos.",
    link: "/courses",
  },
  {
    title: "Consultation",
    description:
      "Personalized Astrological Guidance for Life’s Biggest Decisions.",
    link: "/consulting",
  },
  {
    title: "Books",
  ...
  return (
    <div className="bg-gray-100 min-h-screen text-sm">
      ...
      >
        ...
        {/* Heading */}
        <p className="relative text-xl md:text-4xl font-extrabold text-red-600 text-center">
          Welcome to{" "}
          <strong className="text-2xl lg:text-5xl">Vahlay Astro</strong>
        </p>
      </div>
      ...
      <div className="max-w-screen-xl mx-auto px-6 lg:px-20 py-6 md:py-16 space-y-6 md:space-y-16">
        ...
        <section className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="lg:w-1/2 space-y-6">
            ...
            <p className="text-gray-700">
              At <strong>Vahlay Astro</strong>, we blend ancient Vedic astrology
              with modern insights to guide individuals and businesses through
              life's challenges.
            </p>
            <h3 className="text-xl md:text-4xl font-bold text-red-600 mb-4">
              Our Philosophy
            </h3>
            <p className="text-gray-700">
              We empower clients through personalized consultations that provide
              clarity on career, relationships, and life purpose.
            </p>
          </div>
        </section>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-12">
          <div className="bg-white p-8 rounded-lg shadow-lg text-center">
            ...
            <p className="text-gray-700 text-xs lg:text-base leading-relaxed">
              Our ambition is to empower individuals to live with greater
              awareness, purpose, and harmony by unlocking the wisdom of the
              stars. We strive to provide guidance that helps our clients
              navigate life’s challenges and embrace opportunities.
            </p>
          </div>
          <div className="bg-white p-8 rounded-lg shadow-lg text-center">
            <h3 className="text-2xl font-bold text-red-600 mb-4">Our Vision</h3>
            <p className="text-gray-700 text-xs lg:text-base leading-relaxed">
              Our vision is to empower individuals by blending ancient
              astrological wisdom with modern life, helping them align with
              cosmic forces to make informed decisions and lead fulfilling
              lives.
            </p>
          </div>
        </section>
        ...
        <section className="bg-gray-200 py-12 px-8 rounded-lg shadow-lg">
          <h2 className="text-xl md:text-4xl font-bold text-gray-800 text-center mb-8">
            Core Values
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              {
                title: "Integrity",
                description: "Transparency and honesty in everything we do.",
                icon: "🛡️",
              },
              {
                title: "Empathy",
                description:
                  "Understanding and addressing each client's unique needs.",
                icon: "🤝",
              },
              {
                title: "Innovation",
              ...
              },
              {
                title: "Excellence",
                description:
                  "Striving for the highest quality in our services.",
                icon: "🏆",
              },
            ].map((value, index) => (
              <div
        ...
        <section className="bg-white p-8 rounded-lg shadow-lg text-center">
          <h2 className="text-xl md:text-4xl font-bold text-red-600 mb-8">
            Services We Offer
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              ...
              >
                ...
                <p className="text-gray-600 text-xs lg:text-sm mt-4">
                  {service.description}
                </p>
                {service.link && (
                  <Link
                    to={service.link}
                    className="absolute inset-0 flex items-center justify-center text-white bg-black bg-opacity-0 hover:bg-opacity-40 transition-opacity"
                  >
                    Learn More
                  </Link>
                )}
        ...
        <section className="bg-gradient-to-r from-red-600 to-red-600 text-white py-12 px-8 rounded-lg text-center">
          ...
          <p className=" text-sm  lg:text-lg mb-6">
            Let<strong> Vahlay Astro</strong> guide you toward a future filled
            with clarity, harmony, and success.
          </p>
          <Link to="/services">
            <button className="bg-white text-red-600 px-6 py-1 text-sm  lg:text-xl rounded-full font-semibold hover:bg-gray-100 transition">
              Explore Services
            </button>
          </Link>
        </section>
      ...
      <div className="bg-gradient-to-br from-red-500 via-red-600 to-red-700 p-8 text-center">
        ...
        <Swiper
          ...
          spaceBetween={30}
          className="w-full max-w-7xl md:hidden"
        >
