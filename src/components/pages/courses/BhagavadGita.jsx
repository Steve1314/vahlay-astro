        ...
        <div className="space-y-4 md:w-2/3">
          ...
          <div>
            <p className="text-red-900">
              <span className="font-bold text-red-900">4.5 stars</span> | 80 ratings
            </p>
            </div>

          {/* Subtitle */}
          <p className="text-red-600 text-lg">
          Dive into the spiritual essence of the Bhadvad Geeta.
          </p>
        </div>
  ...
  <div className=" w-3/4 py-6 relative ">
    <div className="max-w-4xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center">
      ...
      <div className="flex items-center space-x-3 mt-4 md:mt-0">
        ...
        <div>
          <p className="text-white font-bold text-lg">Unpaid</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="flex justify-center items-center">
            <img
              src="assets/New edge Bhadvad Geetahp.webp"
              alt="Course"
