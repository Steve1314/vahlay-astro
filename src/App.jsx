  ...
  return (
    <Router>
      ...
      <div className="flex flex-col min-h-screen">
        <Navbar />
        <ScrollToTop />
        <main className="flex-grow pt-0 md:px-0">
          <Tracker />
          <Routes>
            {/* General Routes */}
            ...
            <Route
              path="/pay/:courseId/:emiNumber/:planId/:encodedEmail"
              element={<Payment />}
            />
            {/* Course Routes */}
            ...
            <Route
              path="/coursedetail/:courseId/:courseType"
            ...
            />
            <Route
              path="admin/emailuserlist/:email"
              element={
                <ProtectedRoutes adminOnly={true}>
                  {" "}
                  <EMIDetails />
